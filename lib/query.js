...
var Query = module.exports = function (hashKey, table, serializer) {
  ...
  this.options = {
    loadAll: false,
    sleepEach : 0     /* when sleepEach > 0, pagination will wait sleepEach ms in each request. */
  };
...
Query.prototype.sleepEach = function(value) {
  value = parseInt(value);
  console.assert(value > 1, "value in sleepEach must be unit large then 1.");

  this.options.sleepEach = value;
  return this;
};
